...
import com.api.crud.payload.request.JwtResponse;
...
import com.api.crud.payload.request.LoginRequest;
import com.api.crud.payload.request.SignupRequest;
import com.api.crud.payload.response.UserInfoResponse;
import com.api.crud.payload.response.MessageResponse;
import com.api.crud.repository.IRoleRepository;
import com.api.crud.repository.IUserRepository;
import com.api.crud.security.jwt.JwtUtils;
import com.api.crud.security.services.UserDetailsImpl;
...
public class AuthController {
    ...
    @PostMapping("/signin4")
    public ResponseEntity<?> authenticateUser4(@Valid @RequestBody LoginRequest loginRequest) {
    ...
    public ResponseEntity<?> authenticateUser3(@Valid @RequestBody LoginRequest loginRequest) {
        ...
        return ResponseEntity.ok().header(HttpHeaders.AUTHORIZATION, jwtUtils.generateTokenFromUsername(userDetails.getUsername()))
